...
const peopleItems = buildIndex("people", "sort");
...
// Build research index — sorted by numeric `sort` field
const researchItems = buildIndex("research", "sort");
writeIndex("research", researchItems);
