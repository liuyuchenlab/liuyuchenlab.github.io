...
const i18n = {
  ...
  research: {
    ...
    items: [
      {
        icon: "🧬",
        title: { zh: "转录组数据分析", en: "Transcriptome Analysis" },
        desc: {
          zh: "RNA-Seq 标准化、差异表达、功能富集等全流程方法学研究，关注 ERCC spike-in 与 DESeq2 等方法的比较与改进。",
          en: "Full-pipeline methodology of RNA-Seq normalization, differential expression, and functional enrichment, with focus on comparing and improving methods like ERCC spike-in and DESeq2.",
        },
        tags: ["RNA-Seq", "DESeq2", "ERCC"],
      },
      {
        icon: "🔬",
        title: { zh: "基因集富集分析", en: "Gene Set Enrichment" },
        desc: {
          zh: "支持自定义 GMT 文件的 GSEA 分析，让研究者能便捷地构建与使用领域特异的基因集。",
          en: "GSEA analysis supporting custom GMT files, enabling researchers to easily build and use domain-specific gene sets.",
        },
        tags: ["GSEA", "GMT", "Pathway"],
      },
      {
        icon: "🧪",
        title: { zh: "序列与实验设计", en: "Sequence & Design" },
        desc: {
          zh: "面向基因敲除实验的 sgRNA 设计，提供从转录本到外显子/内含子序列的一键获取工具。",
          en: "sgRNA design for gene knockout experiments, providing one-click tools to obtain exon/intron sequences from transcripts.",
        },
        tags: ["sgRNA", "CRISPR", "Intron"],
      },
      {
        icon: "📊",
        title: { zh: "差异表达与功能注释", en: "DEG & Annotation" },
        desc: {
          zh: "一键获得差异基因与富集结果的集成工具，降低实验生物学家的生信分析门槛。",
          en: "Integrated tools to obtain differentially expressed genes and enrichment results in one click, lowering the bioinformatics barrier for experimental biologists.",
        },
        tags: ["DEG", "Enrichment", "qPCR"],
      },
      {
        icon: "🧫",
        title: { zh: "单细胞与多组学", en: "Single-cell & Multi-omics" },
        desc: {
          zh: "面向单细胞转录组与表观组数据的细胞类型注释、轨迹推断与多组学整合分析。",
          en: "Cell type annotation, trajectory inference, and multi-omics integration for single-cell transcriptome and epigenome data.",
        },
        tags: ["scRNA-Seq", "Trajectory", "Integration"],
      },
      {
        icon: "🧠",
        title: { zh: "发育生物学问题", en: "Developmental Biology" },
        desc: {
          zh: "围绕哺乳动物早期胚胎发育、X 染色体失活等关键生物学问题，开展数据驱动的机制研究。",
          en: "Data-driven mechanistic research on key biological questions such as early embryonic development and X chromosome inactivation in mammals.",
        },
        tags: ["XCI", "Embryo", "Mechanism"],
      },
    ],
  },
    ...
    items: [
      {
        ...
        title: { zh: "转录组数据分析", en: "Transcriptome Analysis" },
        desc: {
          zh: "RNA-Seq 全流程方法学：从数据标准化、差异表达到功能富集。我们关注 ERCC spike-in 对照与 DESeq2 等标准化方法在不同实验场景下的表现与改进，为实验生物学家提供稳健、可重复的分析流程。",
          en: "Full-pipeline methodology of RNA-Seq: from data normalization and differential expression to functional enrichment. We focus on the performance and improvement of normalization methods like ERCC spike-in and DESeq2 across different experimental scenarios, providing robust and reproducible analysis workflows for experimental biologists.",
        },
        tags: ["RNA-Seq", "DESeq2", "ERCC", "Normalization"],
        tools: { zh: "qqercc R 包", en: "qqercc R package" },
      },
      {
        icon: "🔬",
        title: { zh: "基因集富集分析", en: "Gene Set Enrichment" },
        desc: {
          zh: "支持自定义 GMT 文件的 GSEA 分析，让研究者能便捷地构建与使用领域特异的基因集。配套工具一键生成 DIY 的 GMT 文件，降低富集分析的使用门槛。",
          en: "GSEA analysis supporting custom GMT files, enabling researchers to easily build and use domain-specific gene sets. The supporting tool generates DIY GMT files in one click, lowering the barrier to enrichment analysis.",
        },
        tags: ["GSEA", "GMT", "Pathway", "Enrichment"],
        tools: { zh: "qqgmt R 包", en: "qqgmt R package" },
      },
      {
        icon: "🧪",
        title: { zh: "序列与实验设计", en: "Sequence & Design" },
        desc: {
          zh: "面向基因敲除实验的 sgRNA 设计，提供从转录本到外显子/内含子序列的一键获取工具。免去手动复制粘贴内含子序列的繁琐，加速 CRISPR 实验设计流程。",
          en: "sgRNA design for gene knockout experiments, providing one-click tools to obtain exon/intron sequences from transcripts. It eliminates the tedious manual copy-paste of intron sequences and accelerates the CRISPR experiment design workflow.",
        },
        tags: ["sgRNA", "CRISPR", "Intron", "Knockout"],
        tools: { zh: "qqseq R 包", en: "qqseq R package" },
      },
      {
        icon: "📊",
        title: { zh: "差异表达与功能注释", en: "DEG & Annotation" },
        desc: {
          zh: "一键获得差异基因与富集结果的集成工具，把差异表达分析与功能富集整合成单步操作。同时提供 qPCR 相对表达量计算工具，覆盖从测序到验证的全链条。",
          en: "Integrated tools to obtain differentially expressed genes and enrichment results in one click, combining differential expression analysis and functional enrichment into a single step. Also provides qPCR relative expression calculation tools, covering the full chain from sequencing to validation.",
        },
        tags: ["DEG", "Enrichment", "qPCR", "Annotation"],
        tools: { zh: "qqdeg / qqpcr R 包", en: "qqdeg / qqpcr R packages" },
      },
      {
        icon: "🧫",
        title: { zh: "单细胞与多组学", en: "Single-cell & Multi-omics" },
        desc: {
          zh: "面向单细胞转录组与表观组数据的细胞类型注释、轨迹推断与多组学整合分析。关注胚胎发育等稀有细胞群体的识别与命运决择机制研究。",
          en: "Cell type annotation, trajectory inference, and multi-omics integration for single-cell transcriptome and epigenome data. Focus on identification of rare cell populations and fate decision mechanisms during embryonic development.",
        },
        tags: ["scRNA-Seq", "Trajectory", "Integration", "scATAC"],
        tools: { zh: "方法学开发中", en: "Methods in development" },
      },
      {
        icon: "🧠",
        title: { zh: "发育生物学问题", en: "Developmental Biology" },
        desc: {
          zh: "围绕哺乳动物早期胚胎发育、X 染色体失活等关键生物学问题，开展数据驱动的机制研究。通过整合多源组学数据，解析基因调控网络与表观遗传重塑过程。",
          en: "Data-driven mechanistic research on key biological questions such as early embryonic development and X chromosome inactivation in mammals. By integrating multi-source omics data, we dissect gene regulatory networks and epigenetic remodeling processes.",
        },
        tags: ["XCI", "Embryo", "Mechanism", "Epigenetics"],
        tools: { zh: "合作研究", en: "Collaborative research" },
      },
    ],
  },
